class DemoConfig:
    ...
    IS_ACCESS_TOKEN_URL = 'https://pocketfactory-demo.quantis.ai:55335/core/connect/token'
    #IS_ACCESS_TOKEN_URL = 'https://pocketfactory-demo.ssidecisions.com:55335/core/connect/token'
    IS_Scopes = 'idmgr permissions'

    REMOTE_SERVICES = {
        'INFO_SERVICE': 'https://pocketfactory-demo.quantis.ai:44338/api/',
        'DATA_SERVICE': 'https://pocketfactory-demo.quantis.ai:44337/api/',
        'ANALYTICAL_SERVICE': 'https://pocketfactory-demo.quantis.ai:44340/api/'
...
class ProdQaConfig:
    ...
    IS_CLIENT_ID = 'POCKETFACTORY_PROD.CLIENT.CC'
    IS_CLIENT_SECRET = '3FAB5367-27AE-476D-9218-0565A7ACAFFA'
    IS_ACCESS_TOKEN_URL = 'https://pocketfactory-uat.quantis.ai:55335/core/connect/token'
    #IS_ACCESS_TOKEN_URL = 'http://prodqa.northeurope.cloudapp.azure.com:55335/core/connect/token'
    IS_Scopes = 'idmgr permissions'

    REMOTE_SERVICES = {
        'INFO_SERVICE': 'https://pocketfactory-uat.quantis.ai:44338/api/',
        'DATA_SERVICE': 'https://pocketfactory-uat.quantis.ai:44337/api/',
        'ANALYTICAL_SERVICE': 'https://pocketfactory-uat.quantis.ai:44340/api/'
    #
    # REMOTE_SERVICES = {
...
class HbcConfig:
    IS_CLIENT_ID = 'POCKETFACTORY_PROD.CLIENT.CC'
    IS_CLIENT_SECRET = '3FAB5367-27AE-476D-9218-0565A7ACAFFA'
    IS_ACCESS_TOKEN_URL = 'https://pocketfactory.quantis.ai:55335/core/connect/token'
    #IS_ACCESS_TOKEN_URL = 'https://pocketfactory-hbc.ssidecisions.com:55335/core/connect/token'
    IS_Scopes = 'idmgr permissions'

    REMOTE_SERVICES = {
        'INFO_SERVICE': 'https://pocketfactory.quantis.ai:44338/api/',
        'DATA_SERVICE': 'https://pocketfactory.quantis.ai:44337/api/',
        'ANALYTICAL_SERVICE': 'https://pocketfactory.quantis.ai:44340/api/'
